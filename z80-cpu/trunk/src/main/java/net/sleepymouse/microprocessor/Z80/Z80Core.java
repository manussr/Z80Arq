...
public class Z80Core implements ICPUData
{
	...
	//Get registros principales
	public String getRegA() {
		return Integer.toHexString(reg_A);
	}
	public String getRegB() {
		return Integer.toHexString(reg_B);
	}
	public String getRegC() {
		return Integer.toHexString(reg_C);
	}
	public String getRegD() {
		return Integer.toHexString(reg_D);
	}
	public String getRegF() {
		return Integer.toHexString(reg_F);
	}
	public String getRegE() {
		return Integer.toHexString(reg_E);
	}
	public String getRegH() {
		return Integer.toHexString(reg_H);
	}
	public String getRegL() {
		return Integer.toHexString(reg_L);
	}
	//get reg secundarios
	public String getRegA_ALT() {
		return Integer.toHexString(reg_A_ALT);
	}
	public String getRegB_ALT() {
		return Integer.toHexString(reg_B_ALT);
	}
	public String getRegC_ALT() {
		return Integer.toHexString(reg_C_ALT);
	}
	public String getRegD_ALT() {
		return Integer.toHexString(reg_D_ALT);
	}
	public String getRegE_ALT() {
		return Integer.toHexString(reg_E_ALT);
	}
	public String getRegF_ALT() {
		return Integer.toHexString(reg_F_ALT);
	}
	public String getRegH_ALT() {
		return Integer.toHexString(reg_H_ALT);
	}
	public String getRegL_ALT() {
		return Integer.toHexString(reg_L_ALT);
	}
	
	//get reg 16B
	public String getRegIX() {
		return Integer.toHexString(reg_IX);
	}
	public String getRegIY() {
		return Integer.toHexString(reg_IY);
	}
	
	public final String mgetBC()
	{
		return Integer.toHexString((reg_B << 8) + reg_C);
	}

	public final String mgetDE()
	{
		return Integer.toHexString((reg_D << 8) + reg_E);
	}

	public final String mgetHL()
	{
		return Integer.toHexString((reg_H << 8) + reg_L);
	}

	public final String mgetBC_ALT()
	{
		return Integer.toHexString((reg_B_ALT << 8) + reg_C_ALT);
	}

	public final String mgetDE_ALT()
	{
		return Integer.toHexString((reg_D_ALT << 8) + reg_E_ALT);
	}

	public final String mgetHL_ALT()
	{
		return Integer.toHexString((reg_H_ALT << 8) + reg_L_ALT);
	}
	...
	public String getI() {
		return Integer.toHexString(reg_I);
	}
	
	public String getR() {
		return Integer.toHexString(reg_R);
	}
